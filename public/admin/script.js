var myhobby={
  ...
  function togglehobbyData() {
    var hobbyData = document.getElementById("hobbyDataContainer");
    if (hobbyData.style.display == "block") {
      hobbyData.style.display = "none";
    } else {
      hobbyData.style.display = "block";
    }
  }
  ...
  function updateData(e) {
    ...
    updatedBook.colour = document.getElementById("color").value;
    ...
    updatedBook.publishingyear = document.getElementById("pubdate").value;
  ...
  function updatehobbyData(e) {
    ...
    updatedhobby.date = document.getElementById("date").value;
    updatedhobby.gender = document.getElementById("gender").value;
    updatedhobby.player = document.getElementById("player").value;
    updatedhobby.years = document.getElementById("years").value;
